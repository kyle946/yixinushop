...
?>
    ...
    <body>
        ...
        <?php
            $bool = 1;
            //版本检测
            $flag = version_compare(PHP_VERSION, '5.5.38','>=');
            if( !$flag ){ $bool = 0; }
            //扩展检测
            $var1 = array();
            ...
            $checkmysql = 0;
            if(array_key_exists('mysql', $exts) ){  $checkmysql=1;   }else{ $bool = 0; }
            $checkredis = 0;
            if(array_key_exists('redis', $exts) ){  $checkredis=1;   }else{ $bool = 0; }
        ?>
        <div class="area1" >
            <div class="w1 h30" ></div>
            ...
            <table class="w2 table1" >
                ...
                <tr>
                    ...
                    <td>5.5.38 <?php if($flag){ ?><font>检测通过</font><?php }else{ ?><font class="f2" >检测失败</font><?php } ?></td>
                </tr>
            </table>
            <table class="w2 table1" >
                <tr>
        ...
        <?php
            if( $_SERVER["REQUEST_METHOD"] == 'POST' ){
                ...
                //开始替换配置文件
                $tmpstr = str_replace('127.0.0.1', $dbpath, $tmpstr);
                ...
                $tmpstr = str_replace('y_', $redispre, $tmpstr);
